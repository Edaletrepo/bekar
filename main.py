...
def command_start(update, context: CallbackContext):
    if update.effective_chat.type == "private":
        ...
        addme = InlineKeyboardButton(text="🧚 Qrupa əlavə edin!", url="https://t.me/bekargamebot?startgroup=a")
        sohbet = InlineKeyboardButton(text="💬 Söhbət Qrupumuz", url="https://t.me/edaletsup")
        oyun = InlineKeyboardButton(text="👾 Oyun Qrupumuz", url="https://t.me/edaletsup")
        admin = InlineKeyboardButton(text="👨🏻‍💻 Sahib", url="https://t.me/jelilarass")
